const { api, event, Users } = require('some-facebook-chat-api'); // Actual API module yahan replace karein
...
module.exports.config = {
    ...
    description: "Specific keywords aur emojis pe automatic replies",
...
module.exports.handleEvent = async function({ api, event, Users }) {
    ...
    for (let key in replies) {
        if (lowerCaseBody.includes(key)) {
            ...
            const replyOptions = replies[key];
            ...
            break;  // pehli match milte hi loop se bahar niklenge
        }
    }
};

module.exports.run = function({ api, event, client, __GLOBAL }) {
    // No command functionality needed
};
